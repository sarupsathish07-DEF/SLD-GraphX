...
| Source-feeder-v1 | Project-generated SLDForge canonical fixtures, six topology families | frozen M5 semantic source, feeder, exact-path, switch-state and criticality checks | project-controlled synthetic; canonical graph reasoning only, not end-to-end perception or real-data validation |
